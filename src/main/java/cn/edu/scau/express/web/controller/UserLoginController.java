...
public class UserLoginController {
    ...
    public String LoginSuccess(Model model, UserLogin userLogin){
        UserLogin userLogin1 = userLoginServicesImpl.queryById(userLogin.getUser_id(),userLogin.getUser_psw());
...
//            System.out.println(userLogin1.toString());
            String psw = userLoginServicesImpl.queryPswById(userLogin1.getUser_id());
